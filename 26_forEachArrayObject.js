...
console.error(`~~~~~~~~~~~~~~~~~~~~~~~~~~ Total Salary of TCS and Infy Employee ~~~~~~~~~~~~~~~~~~~~~~~~~~~`);
let totalSalTcsInfy = 0;
arrayEmployees.forEach(employee => {
    if (employee.empCompany == "TCS" || employee.empCompany == "Infy") {
        totalSalTcsInfy = totalSalTcsInfy + employee.empSalary;
    }
});
console.log(totalSalTcsInfy);
